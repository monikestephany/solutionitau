...
using itau.doc.ext.api.core;
using itau.doc.ext.api.core.Contracts;
using itau.doc.ext.api.core.Entities;
using itau.doc.ext.api.core.Entities.Dtos;
using itau.doc.ext.api.core.Services;
using itau.doc.ext.api.core.Validators;
...
namespace itau.doc.ext.api.application
{
        ...
        {   
         ...
         Configuration.GetSection(nameof(RabbitConfiguration)));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Doc API Externa",
                    Description = "API do serviço Doc Externa.\n\nVersão v1" + ". <style>.models {display: none !important}</style>",
