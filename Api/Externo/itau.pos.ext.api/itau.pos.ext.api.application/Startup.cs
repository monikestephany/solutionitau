...
using itau.pos.ext.api.core;
using itau.pos.ext.api.core.Contracts;
using itau.pos.ext.api.core.Entities;
using itau.pos.ext.api.core.Entities.Dtos;
using itau.pos.ext.api.core.Services;
using itau.pos.ext.api.core.Validators;
...
namespace itau.pos.ext.api.application
{
        ...
        {   
         ...
         Configuration.GetSection(nameof(RabbitConfiguration)));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Pos API Externa",
                    Description = "API do serviço Pos Externa.\n\nVersão v1" + ". <style>.models {display: none !important}</style>",
