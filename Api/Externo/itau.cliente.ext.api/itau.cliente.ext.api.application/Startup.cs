...
using itau.cliente.ext.api.core;
using itau.cliente.ext.api.core.Contracts;
using itau.cliente.ext.api.core.Entities;
using itau.cliente.ext.api.core.Entities.Dtos;
using itau.cliente.ext.api.core.Services;
using itau.cliente.ext.api.core.Validators;
...
namespace itau.cliente.ext.api.application
{
        ...
        {   
         ...
         Configuration.GetSection(nameof(RabbitConfiguration)));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Cliente API Externa",
                    Description = "API do serviço Cliente Externa.\n\nVersão v1" + ". <style>.models {display: none !important}</style>",
